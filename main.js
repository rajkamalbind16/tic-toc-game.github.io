function myfunc(){
    ...
    b3=document.getElementById("b2").value;
    ...
    if((b1=='O'||b1=='O')&&(b2=='O'|| b2=='O')&&(b3=='O'||b3=='O')){
    ...
    else if((b1=='X'||b1=='O')&&(b2=='X'||b2=='O')&&(b3=='X'||b3=='O')&&(b3=='X'||b3=='O')&&(b4=='X'||b4=='O')&&(b5=='X'||b5=='O')&&(b6=='X'||b6=='O')&&(b7=='X'||b7=='O')&&(b8=='X'||b8=='O')&&(b19='X'||b9=='O')){
        ...
        if(flag==1){
            ...
            document.getElementById("print").innerHTML=("Player O turns");
        }
    }
